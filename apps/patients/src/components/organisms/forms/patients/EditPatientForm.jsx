        ...
        <form onSubmit={handleSubmit(onFormSubmit)}>
            <Card>
                <CardBody className='p-8 space-y-10'>
                    ...
                    <FormGroup title={t('patients.form.label.registration_information')}>
                        <div className='grid md:grid-cols-3 grid-cols-1 gap-4'>
                            <div className="col-span-1">
                                <Input
                                    ...
                                    label={t('patients.form.input.registration_number')}
                                    errors={errors}
                                />
                            </div>
                            ...
                            <div className="col-span-1">
                                <Input
                                    ...
                                    placeholder={t('patients.form.input.registration_date')}
                                    label={t('patients.form.input.registration_date')}
                                    errors={errors}
                                />
                            </div>
                        </div>
                    ...
                    <FormGroup title={t('patients.form.label.personal_detail')}>
                        ...
                        <div className="col-span-1">
                                <Input
                                    ...
                                    register={register}
                                    name='age'
                                    placeholder={t('patients.form.input.age')}
                                    label={t('patients.form.input.age')}
                                    errors={errors}
                                />
                            </div>
