...
import BirthTable from '../../organisms/tables/births/Index';
import BirthActivityModal from '../../organisms/modals/births/BirthActivityModal';
...
const BirthPatientTemplate = () => {
    const navigate = useNavigate();

    const [isBoardCardModal, setIsBoardCardModal] = useState(false);
        
    const onEditBirth = (params) => {
        return navigate(`/patients/birth/${params.id}/edit`);
    }

    const onClickOpenBirthBoard = () => {
        setIsBoardCardModal(true);
    }

    const onClickCloseBirthBoard = () => {
    ...
    return (
        <>
            ...
            <BirthActivityModal
                title={'Birth Activity'}
                isOpen={isBoardCardModal}
                onClose={onClickCloseBirthBoard}
            />
        </>
    )
}

export default BirthPatientTemplate;
